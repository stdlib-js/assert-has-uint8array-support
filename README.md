...
```javascript
hasUint8ArraySupport = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-uint8array-support@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-uint8array-support@v0.2.0-umd/browser.js"></script>
```
